...
SELECT create_hypertable('blood_volume_pulse','ts',chunk_time_interval => INTERVAL '1 days');
...
SELECT create_hypertable('interstitial_glucose','ts',chunk_time_interval => INTERVAL '1 days');
...
SELECT create_hypertable('electrodermal_activity','ts',chunk_time_interval => INTERVAL '1 days');
...
SELECT create_hypertable('heart_rate_data','datetime',chunk_time_interval => INTERVAL '1 days');
...
SELECT create_hypertable('ibi_data','event_time',chunk_time_interval => INTERVAL '1 days');
...
SELECT create_hypertable('temperature_data','event_time',chunk_time_interval => INTERVAL '1 days');
